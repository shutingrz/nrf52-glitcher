...
void nrf_read_ufcr()
{
  nrf_ufcr.codepage_size = read_register(0x10000010, 1);
  nrf_ufcr.codesize = read_register(0x10000014, 1);
  nrf_ufcr.flash_size = nrf_ufcr.codepage_size * nrf_ufcr.codesize;
  nrf_ufcr.config_id = read_register(0x1000005c, 1);
  nrf_ufcr.device_id0 = read_register(0x10000060, 1);
  nrf_ufcr.device_id1 = read_register(0x10000064, 1);
  nrf_ufcr.info_part = read_register(0x10000100, 1);
